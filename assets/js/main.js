...
const scrollHeader =() => {
    ...
    this.scrollY  >= 10 ? header.classList.add('bg-header') : header.classList.remove('bg-header');
}
...
const scrollUp = () => {
    ...
    // When scroll is higher than 350 viewport height, show the scroll arrow else display nothing...
